...
export function PageSectionNav({
  ...
  return (
    <div className="space-y-3">
      <div className="overflow-x-auto rounded-[28px] border border-[var(--border-subtle)] bg-[var(--surface-1)] p-2 shadow-[var(--shadow-soft)]">
        <div className="flex flex-nowrap gap-2">
          {items.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                [
                  'shrink-0 rounded-[22px] px-4 py-3 text-sm font-medium transition',
                  isActive
